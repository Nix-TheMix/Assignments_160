...
[CreateAssetMenu(fileName = "EnemyData", menuName = "Enemy Data")] //doesnt need a ;makes it easier to compile code
public class EnemyData : ScriptableObject
{
    ...
    {
        EnemyHealth1 -= damage;
        Debug.Log(EnemyName + " has been hit!  Health = " + EnemyHealth); //debug used because not mono behavior
    }
}
